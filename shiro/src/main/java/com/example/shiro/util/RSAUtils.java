...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object publicKey =  map.get(RSAUtils.PUBLIC_KEY);
        Object privateKey = map.get(RSAUtils.PRIVATE_KEY);
        ...
        byte[] bytes = RSAUtils.encryptByPublicKey(username.getBytes("GBK"), pubKey);
        String encoded = Base64.getEncoder().encodeToString(bytes);
        System.out.println("1"+encoded);

        byte[] bytes1 = RSAUtils.decryptByPrivateKey(bytes, priKey);
        String encoded1 = Base64.getEncoder().encodeToString(bytes1);
        System.out.println("2"+encoded1);
